...
def generar_reporte_checkin_ajax(request):
    ...
    try:
        ...
        prompt = (
            ...
            "REGLA CRÍTICA DE FORMATO: cada uno de los dos textos debe tener aproximadamente 700-720 caracteres "
