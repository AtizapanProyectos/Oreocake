...
urlpatterns = [
    ...
    path('generar-bitacora-meet-ia/<int:cita_id>/', views.api_generar_bitacora_automatica_meet, name='generar_bitacora_meet_ia'),
    path('admin/procesar-bitacoras-historicas-meet/', views.api_procesar_bitacoras_historicas_meet, name='procesar_bitacoras_historicas_meet'),
